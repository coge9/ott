 ...
 * requiredPostMpxVideoBlurb
 */
@Component("requiredPostMpxVideoBlurb")
public class RequiredFieldPostAndMpxVideoBlurb implements ContentTypeCreationStrategy {
    ...
    public Content createContentType() {
        ...
        post.setPostInfo(PostInfoCreator.getMpxVideoBlurb());
        return post;
    }
}
