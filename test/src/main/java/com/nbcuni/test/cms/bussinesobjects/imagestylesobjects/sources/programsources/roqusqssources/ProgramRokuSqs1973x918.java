...
import static com.nbcuni.test.cms.bussinesobjects.imagestylesobjects.ImageStyles.landscape_1429x608_x1;

/**
 * Created by Dzianis_Kulesh on 4/12/2017.
 */
public class ProgramRokuSqs1973x918 implements Source {

    private static final String CONCERTO_USAGE = ImageUsage.DYNAMIC_LEAD.getUsage();

    private List<ImageStyles> imageStyles = Arrays.asList(landscape_1429x608_x1);
