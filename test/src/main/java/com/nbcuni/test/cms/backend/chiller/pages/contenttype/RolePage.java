...
public class RolePage extends PersonRoleAbstractPage {

    public RolePage(CustomWebDriver webDriver, AppLib aid) {
        super(webDriver, aid);
    }

    @Override
    public RolePage enterContentTypeData(Content content) {
        enterMetadataInfo((RoleEntity) content);
    ...
    @Override
    public RolePage create(Content content) {
        this.enterContentTypeData(content).saveAsDraft();
        return this;
    }

    @Override
    public RolePage createAndPublish(Content content) {
