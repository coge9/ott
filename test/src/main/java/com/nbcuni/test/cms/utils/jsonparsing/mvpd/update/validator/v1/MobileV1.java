...
public class MobileV1 extends AbstractValueValidator implements IValueValidator {

    private static final MvpdEntitlementsServiceVersion VERSION = MvpdEntitlementsServiceVersion.V1;
    private static final Platform PLATFORM = Platform.MOBILE;
    private final Instance instance;

    public MobileV1(Instance instance) {
    ...
    public boolean validateDefault(MvpdFeed mvpdFeed, Mvpd mvpd, Brand brand) {
        ...
        if (BrandsMvpdAdmin.getBrandById(brand.getBrandRequestorId()) != null &&
                BrandsMvpdAdmin.getBrandById(brand.getBrandRequestorId()).equals(BrandsMvpdAdmin.CNBC)) {
