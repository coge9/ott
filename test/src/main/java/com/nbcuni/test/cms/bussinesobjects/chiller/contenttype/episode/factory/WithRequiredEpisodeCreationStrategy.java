...
@Component("withRequiredEpisode")
public class WithRequiredEpisodeCreationStrategy implements ContentTypeCreationStrategy {
    @Override
    ...
    public static class WithAllEpisodeCreationStrategy implements ContentTypeCreationStrategy {
        @Override
        public Content createContentType() {
            String postfix = SimpleUtils.getRandomString(6);
            Integer episodeNumber = SimpleUtils.getRandomIntInRange(1, 999);
