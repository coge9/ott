 ...
 * requiredPostYouTubeBlurb
 */
@Component("requiredPostYouTubeBlurb")
public class RequiredFieldPostAndYouTubeBlurb implements ContentTypeCreationStrategy {
    ...
    public Content createContentType() {
        ...
        post.setPostInfo(PostInfoCreator.getYouTubeBlurb());
        return post;
    }
}
