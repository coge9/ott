 ...
 * 2. Create new Collection with required fields [collection_name]
 * Collection is created
 * 3. Try create new Collection with required fields [collection_name]
 * Error message "Title is not unique" is present. New Collection is not created
 * 4. Change title and save
 * Error message is not present
 * Content with new title is created
 */

public class TC15578_Collection_CheckUniqueTitle extends BaseAuthFlowTest {
    ...
    public void creationTitle(final String brand) {
        ...
        softAssert.assertContains(collectionPage.getErrorMessage(), String.format(MessageConstants.TITLE_IS_ALREADY_USED_FOR_CURATED_COLLECTION,
