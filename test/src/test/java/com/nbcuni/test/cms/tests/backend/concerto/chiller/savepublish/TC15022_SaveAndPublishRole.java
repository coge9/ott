 ...
 */
public class TC15022_SaveAndPublishRole extends BaseAuthFlowTest {
    ...
    public void savePublishRole(final String brand) {
        ...
        //Step 2
        ContentTypePage contentTypePage = (ContentTypePage) mainRokuAdminPage.openPage(role.getPage(), brand);
        ...
        //Step 5-7
        contentTypePage = rokuBackEndLayer.createContentType(role);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(role.getTitle()), "The node state is Published", "The node state is Not Published", webDriver);

        //Step 9
        contentTypePage = rokuBackEndLayer.editContentType(role);
        ...
        contentPage.searchByTitle(role.getTitle()).apply();
        ...
        //Step 17
        mainRokuAdminPage.openPage(MetadataPage.class, brand);
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(role.getTitle()), "The node state is Published after draft save"
        ...
        //Step 21
        mainRokuAdminPage.openPage(MetadataPage.class, brand);
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(role.getTitle())
