 ...
 */
public class TC15021_SaveAndPublishNewEvent extends BaseAuthFlowTest {
    ...
    public void savePublishEvent(final String brand) {
        ...
        ContentTypePage contentTypePage = rokuBackEndLayer.createAndPublishContentType(event);
