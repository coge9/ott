 ...
 */
public class TC15029_SaveAndPublishingFailForEvent extends SetupAmazonEndpoint {
    /**
    ...
    public void savePublishFailEvent(final String brand) {
        //Step 1
        ...
        //Step 2-3
        ContentTypePage contentTypePage = rokuBackEndLayer.createContentType(event);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(event.getTitle()), "The node state is Published"
                , "The node state is not Published", webDriver);

        //Step 7
        rokuBackEndLayer.editContentType(event);
        contentTypePage.publish(endpoint);
    ...
    public void deleteEventTC15029() {
