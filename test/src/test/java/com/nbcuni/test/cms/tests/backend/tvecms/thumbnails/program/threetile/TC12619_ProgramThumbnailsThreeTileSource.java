...
import com.nbcuni.test.cms.utils.thumbnails.rokuimages.Program3TileSource;
...
public class TC12619_ProgramThumbnailsThreeTileSource extends BaseAuthFlowTest {
    ...
    public void checkInitialThumbnails(String brand) {
        ...
        mpxLayer.updateSourceWithTestData(Program3TileSource.getSourcePerBrand(brand));
    ...
    public void checkOneTileThumbnailIsGeneratedForProgram(String brand) {
        ...
        Map<CustomImageTypes, String> threeTileImagesSource = programContentPage.onRokuImagesTab().getThreeTileProgramCustomLinks();
    ...
    public void setAllBack() {
        ...
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_PROGRAM);
        mpxLayer.updateSourceWithOldData(Program3TileSource.getSourcePerBrand(brand));
    }
