 ...
 */
public class TC15024_SaveAndPublishCollectionGroup extends BaseAuthFlowTest {
    ...
    public void savePublishCollectionGroup(final String brand) {
        ...
        //Step 4
        softAssert.assertTrue(collectionPage.cancel().isPageOpened(), "Content page is not opened",
        ...
        //Step 9
        collectionPage = collectionsPage.openEditCollectionGroupPage(collection);

        //Step 10
        softAssert.assertTrue(collectionPage.cancel().isPageOpened(), "Collection page is not opened",
                "Collection page is opened", webDriver);
    ...
    public void deleteCollectionGroupTC15024() {
        try {
