...
public class TC10794_GeneratedHeaderWithoutPageTitleWithoutMenuForAllMvpds extends
        BaseAuthFlowTest {

    private static PageForm pageForm = null;
    Map<String, Map<String, String>> mvpds;
    /**
     * TC10794 - Roku CMS: Generated header "Header without Page Title without menu" for all MVPDs
     *
    ...
    private String pageTitle = "HG VO Without T Without M";
    ...
    public void createPageAll() {
        ...
        optimumExpHeader = new File(Config.getInstance()
                .getPathToRokuHeaderGenerationImages(brand)
                + "Cablevision_WithoutMenuWithoutTitle.png");
    ...
    public void headerImageGenerationForOneMvpd(String brand) {
        ...
        headerImageGenerationPage.generateOttPageHeaders(pageTitle,
                HeaderStyle.WITHOUT_TITLE_WITHOUT_MENU, allMvpdsDdlValue);
