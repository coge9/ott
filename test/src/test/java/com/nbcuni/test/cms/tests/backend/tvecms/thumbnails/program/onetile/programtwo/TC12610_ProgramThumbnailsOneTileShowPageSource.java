...
public class TC12610_ProgramThumbnailsOneTileShowPageSource extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForProgram(String brand) {
        ...
        Map<CustomImageTypes, String> oneTileImagesProgramSource = programContentPage.onRokuImagesTab().getOneTileProgramTwoCustomLinks();
    ...
    public void setAllBack() {
        ...
        programContentPage.typeShowPageCTA(MpxProgramMetadata.getOldMetadata().getFeatureCTA());
        programContentPage.clickSave();
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_PROGRAM);
