 ...
 */
public class TC10043_UpdateAllEditorsFieldsAndMPXImage extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        String patterFilePath = GettingImages.getAllFieldsAndImageUpdated1TileProgram1();
        softAssert.assertTrue(ImageUtil.compareScreenshotAndUrl(patterFilePath,
