 ...
 * 4. Set for source assetType = thumbnail3, thumbnail2, original image and save
...
public class TC12575_SourceImageIsTriggeredInCMSIfThumbnail3ExistInAssettypeList extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_PROGRAM);
        mpxLayer.updateImageAssetTypeByTitle(INITIAL_IMAGE, "Thumbnail3", "Thumbnail", "Original Image");
        mainRokuAdminPage.runCron(brand);
        ...
        String actualSource = programContentPage.onRokuImagesTab().elementThreeTitleArea().getLinkToSourceImage();

        softAssert.assertTrue(ImageUtil.compareUrlAndUrl(expectedSource, actualSource, 100.0),
                "Images source '3 tile program 1' are not equals", "Images source '3 tile program 1' are equals");
