 ...
 * 2. Create new Post with required fields [post_name]
 * Post is created
 * 3. Try create new Post with required fields [post_name]
 * Error message "Title is not unique" is present. New Post is not created
 * 4. Change title and save
 * Error message is not present
 * Content with new title is created
 */

public class TC15576_Post_CheckUniqueTitle extends BaseAuthFlowTest {
