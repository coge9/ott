...
public class TC14205_UploadedImagesAreSavedInLibrary extends BaseAuthFlowTest {
    ...
    public void creationMediaGallery(String brand) {
        ...
        contentTypePage.onMediaTab().onMediaBlock().isImagesPresentInLibrary(expected, softAssert);
