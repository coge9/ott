 ...
 */
public class TC15165_PublishProgramImageByMPXUpdater extends BaseAuthFlowTest {

    /**
     * Pre-Conditions:
     * Make Sure IOS Concerto API instance is configured on brand
     * There is a Program 1 within MPX
     * Get MPX id of the program
     *
     * Steps:
     ...
     * Step 3: Set MPX ID of Program 1 from pre-condition and update
     ...
     * Make sure that only fields below are filled and matched Program's values,
