 ...
 * 4. Set for source assetType = thumbnail2,thumbnail3,original image and save
...
public class TC12573_SourceImageIsTriggeredInCMSIfThumbnail2ExistInAssettypeList extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_PROGRAM);
        mpxLayer.updateImageAssetTypeByTitle(INITIAL_IMAGE, "Thumbnail2", "Thumbnail", "Original Image");
        mainRokuAdminPage.runCron(brand);
