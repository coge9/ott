 ...
 * 4)Manage revision
 */
public class TC11541_CheckThatEditorCouldCreateFeatureCarouselModule extends BaseAuthFlowTest {
    ...
    public void checkThatAdminCouldCreateFeatureCarouselModule(String brand) {
        Utilities.logInfoMessage("Check that Editor could create Feature Carousel module");
        ...
        softAssert.assertEquals(actualFeatureCarousel, featureCarouselForm,
