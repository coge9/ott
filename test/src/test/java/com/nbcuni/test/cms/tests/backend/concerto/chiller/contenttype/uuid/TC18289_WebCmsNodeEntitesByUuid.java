 ...
 * @Lyoha
 */
public class TC18289_WebCmsNodeEntitesByUuid extends BaseAuthFlowTest {
    ...
    public void checkUUID(String brand) {
        ...
        ContentTypePage contentTypePage = rokuBackEndLayer.openRandomContentTypePage();
        String expectedUrl = webDriver.getCurrentUrl();
        String uuid = contentTypePage.openDevelPage().getUuid();
