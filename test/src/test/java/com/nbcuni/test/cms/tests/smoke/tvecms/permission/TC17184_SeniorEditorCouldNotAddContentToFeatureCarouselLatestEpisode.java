 ...
 */
public class TC17184_SeniorEditorCouldNotAddContentToFeatureCarouselLatestEpisode extends BaseAuthFlowTest {
     ...
     * Pre-Conditions:
     * Go to CMS as Admin
     * Create a module (Any type, e.g custom) with alias 'latestEpisodes' and save.
     * Log out
     * <p>
     * Steps:
     * 1.Go to CMS as Senior Editor
     * Verify: User is logged in to CMS with Senior Editor permission.
     * <p>
