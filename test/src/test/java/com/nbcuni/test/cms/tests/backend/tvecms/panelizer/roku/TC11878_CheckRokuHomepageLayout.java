 ...
 *
 * Step 5: Go to Layout for our template and select Roku layout, click Continue » Save
 *
 * Validation: Check 1 column
 * Check drag'n'drop modules
 * Expected result: 1 column is present
 * Can be possible to drag'n'drop modules
 */

public class TC11878_CheckRokuHomepageLayout extends BaseAuthFlowTest {

    PanelizerTemplates panelizerTemplate = PanelizerTemplates.ROKU_HOMEPAGE;
