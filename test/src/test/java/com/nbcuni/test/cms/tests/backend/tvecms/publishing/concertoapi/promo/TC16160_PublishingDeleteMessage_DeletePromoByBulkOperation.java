 ...
 * 2.
 * Delete Promo by bulk operation
 * Promo is deleted.
 ...
 * entityType = 'promo'
 */
public class TC16160_PublishingDeleteMessage_DeletePromoByBulkOperation extends BaseAuthFlowTest {
    ...
    public void promoPublishing(String brand) {
        ...
        rokuBackEndLayer.deleteContentTypesByBulkOperation(promo);
