...
public class TC18318_PublishAllVideosSortByTitle extends BaseAuthFlowTest {

    private static PageForm pageForm;
    private Dynamic dynamic = CreationFactoryDynamicModule.createDynamicForVideo(SortingType.TITLE);

    @Test(groups = {"module_publishing"}, dataProviderClass = StaticBrandsProvider.class, dataProvider = "brandHasIOSDataProvider")
    public void publishAllVideosSortByTitle(String brand) {
