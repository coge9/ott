 ...
 * 2. Create new Media Gallery with required fields [media_gallery_name]
 * Media Gallery is created
 * 3. Try create new Media Gallery with required fields [media_gallery_name]
 * Error message "Title is not unique" is present. New Media Gallery is not created
 * 4. Change title and save
 * Error message is not present
 * Content with new title is created
 */

public class TC15577_MediaGallery_CheckUniqueTitle extends BaseAuthFlowTest {
    ...
    @Test(groups = {"madia_gallery"}, dataProviderClass = StaticBrandsProvider.class, dataProvider = "brandChillerDataProvider")
