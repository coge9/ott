...
public class TC14203_UploadingSeveralImagesToContentType extends BaseAuthFlowTest {
    ...
    public void creationMediaGallery(final String brand) {
        ...
        //Step 2-4
        contentTypePage.onMediaTab().onMediaBlock().uploadImages(imageCount);
        ...
        softAssert.assertTrue(actual.size() == imageCount, "Count of images is wrong: expected: [" + imageCount + "], actual [" + actual.size() + "]", "Images count is correct", webDriver);
