 ...
 */
public class TC16102_CustomRuleIos extends BaseAuthFlowTest {
    ...
    private void customRuleIOS(String brand) {
        ...
        custom = (Shelf) rokuBackEndLayer.getRulesStrategyForConcerto(ShelfType.SHELF, rokuBackEndLayer.getPublishedPrograms(2), 1);
