 ...
 * 3. Make sure threre is no source with asset type = Original Image, and set for some of them Original image Test
 * the settings for Video is saved
 * 4. Go to CMS as admin and open content ad find Video from pre-condition
 * The Video from pre-condition is present
 * 5. Go to the Edit page of video and check source for 1tile_video_1, 3tile_video_1, 3tile_video_1_now_playing, 3tile_video_1_resume, 3tile_video_2, 3tile_video_2_resume, 3tile_video_4, 3tile_video_5,3 tile_video6, 3tile_video_6_resume, 3tile_video_7, 3tile_video_8 images on the Roku images tab
 * The source is absent for images
 */

public class TC12568_SourceImageNotTriggeredInCMSForIfOriginalImageAssetTypeAbsent extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_VIDEO);
        mpxLayer.updateImageAssetTypeByTitle(INITIAL_IMAGE, "Thumbnail", "Android");
        mainRokuAdminPage.runCron(brand);
