 ...
 */
public class TC15020_SaveAndPublishSeason extends BaseAuthFlowTest {
    ...
    public void savePublishSeason(final String brand) {
        ...
        //Step 2
        ContentTypePage contentTypePage = (ContentTypePage) mainRokuAdminPage.openPage(season.getPage(), brand);
        ...
        //Step 5-7
        contentTypePage = rokuBackEndLayer.createContentType(season);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(season.getTitle()), "The node state is Published", "The node state is Not Published", webDriver);

        //Step 9
        contentTypePage = rokuBackEndLayer.editContentType(season);
        ...
        //Step 17
        contentPage = contentTypePage.cancel();
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(season.getTitle()), "The node state is Published after draft save"
        ...
        //Step 21
        contentPage = contentTypePage.cancel();
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(season.getTitle())
