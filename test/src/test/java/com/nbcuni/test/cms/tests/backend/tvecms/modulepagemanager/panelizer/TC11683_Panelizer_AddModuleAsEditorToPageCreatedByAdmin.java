...
public class TC11683_Panelizer_AddModuleAsEditorToPageCreatedByAdmin extends BaseAuthFlowTest {
    ...
    public void checkThatEditorCouldAddModuleByPanelizerCreatedByAdmin(String brand) {
    ...
    private void deletePageTC11683() {
        try {
