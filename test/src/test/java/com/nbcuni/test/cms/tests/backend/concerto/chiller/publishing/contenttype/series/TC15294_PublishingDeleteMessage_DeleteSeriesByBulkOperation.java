 ...
 * 2.
 * Delete Series by bulk operation
 * Series is deleted.
 ...
 * entityType = 'series'
 */
public class TC15294_PublishingDeleteMessage_DeleteSeriesByBulkOperation extends BaseAuthFlowTest {
    ...
    public void testSeriesDeletePublishing(String brand) {
        ...
        rokuBackEndLayer.deleteContentTypesByBulkOperation(series);
