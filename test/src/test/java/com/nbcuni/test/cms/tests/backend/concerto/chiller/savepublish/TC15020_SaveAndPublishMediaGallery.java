 ...
 */
public class TC15020_SaveAndPublishMediaGallery extends BaseAuthFlowTest {
    ...
    public void savePublishMediaGallery(final String brand) {
        ...
        //Step 2
        ContentTypePage contentTypePage = (ContentTypePage) mainRokuAdminPage.openPage(mediaGallery.getPage(), brand);
        ...
        //Step 5-7
        contentTypePage = rokuBackEndLayer.createContentType(mediaGallery);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(mediaGallery.getTitle()), "The node state is Published", "The node state is Not Published", webDriver);

        //Step 9
        contentTypePage = rokuBackEndLayer.editContentType(mediaGallery);
        ...
        //Step 17
        contentPage = contentTypePage.cancel();
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(mediaGallery.getTitle()), "The node state is Published after draft save"
        ...
        //Step 21
        contentPage = contentTypePage.cancel();
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(mediaGallery.getTitle())
