 ...
 */
public class TC13934_CancelPersonCreationAsAdmin extends BaseAuthFlowTest {
    ...
    public void cancelCreation(final String brand) {
        ...
        Utilities.logInfoMessage("The opened page is Dashboard after person cancelation by Admin");
    }
}
