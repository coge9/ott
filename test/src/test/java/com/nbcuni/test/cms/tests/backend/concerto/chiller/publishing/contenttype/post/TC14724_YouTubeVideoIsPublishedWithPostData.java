 ...
 * Create Post with required fields and blurb info (you tube video)
 * Publish them
 * Verify publish report
 *
 */

public class TC14724_YouTubeVideoIsPublishedWithPostData extends BaseAuthFlowTest {

    private Content content;

    @Autowired
    @Qualifier("requiredPostYouTubeBlurb")
