 ...
 */
public class TC14450_CheckUUIDforMediaGallery extends BaseAuthFlowTest {
    /**
     * Pre-Conditions:Make sure drupal 'Devel' module is switch on
     ...
     2.Create a Media gallery content types
     Verify: Media Gallery has created
     Edit Media Gallery Page is present
    ...
    public void checkUUID(String brand) {
        ...
        contentPage.searchByType(ContentType.TVE_MEDIA_GALLERY).apply();
