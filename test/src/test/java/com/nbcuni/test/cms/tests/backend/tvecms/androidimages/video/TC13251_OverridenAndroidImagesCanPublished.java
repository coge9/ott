 ...
 *  Step 5: Make sure that all images are published
 *
 *
 *
 */

public class TC13251_OverridenAndroidImagesCanPublished extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(String brand) {
        ...
        List<Image> image = videoContentPage.onImagesTab().getAllImages();
