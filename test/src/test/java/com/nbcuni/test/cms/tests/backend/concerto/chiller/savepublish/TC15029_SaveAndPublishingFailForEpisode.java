 ...
 */
public class TC15029_SaveAndPublishingFailForEpisode extends SetupAmazonEndpoint {
    /**
    ...
    public void initBusinessObject() {
        ...
        episode = contentTypeCreationStrategy.createContentType();
    ...
    public void savePublishFailEpisode(final String brand) {
        //Step 1
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(episode.getTitle()), "The node state is Published"
                , "The node state is not Published", webDriver);

        //Step 7
        rokuBackEndLayer.editContentType(episode);
        contentTypePage.publish(endpoint);
        ...
        //Step 14
        mainRokuAdminPage.openPage(ContentPage.class, brand);
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(episode.getTitle()), "The node state is not Published"
    ...
    public void deleteEpisodeTC15029() {
        try {
