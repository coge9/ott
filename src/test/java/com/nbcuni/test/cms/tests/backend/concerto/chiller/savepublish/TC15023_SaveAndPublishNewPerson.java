 ...
 */
public class TC15023_SaveAndPublishNewPerson extends BaseAuthFlowTest {
    ...
    public void savePublishNewPerson(final String brand) {
        ...
        //Step 2
        ContentTypePage contentTypePage = rokuBackEndLayer.createAndPublishContentType(person);
        ...
        softAssert.assertEquals(localApiJson.getResponseStatus(), ResponseData.SUCCESS.getResponseStatus()
                , "The action message attribute are not present"
