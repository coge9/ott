 ...
 */
public class TC15328_PublishUpdatesOfFSModuleIOS extends BaseAuthFlowTest {
     ...
     * Verify: Feature Show custom module has Created
     * <p/>
    ...
    public void checkUpdatedFieldsModulePublishingIOS(String brand) {
        ...
        featureCarousel = draftModuleTab.createFeatureCarousel(updatedFeatureCarousel);
