 ...
 * Step 4: Delete tags
 * Step 5: Check that tags was deleted
 */


public class TC13872_DeleteTagsFromContentType extends BaseAuthFlowTest {
    ...
    public void creationMediaGallery(final String brand) {
        ...
        //Step 4
        contentTypePage.onAssociationsTab().clearTags();
        contentTypePage.saveAsDraft();

        //Step 5
        softAssert.assertTrue(contentTypePage.onAssociationsTab().getTags().isEmpty(), "Tags was not deleted", "All tags was deleted", webDriver);
