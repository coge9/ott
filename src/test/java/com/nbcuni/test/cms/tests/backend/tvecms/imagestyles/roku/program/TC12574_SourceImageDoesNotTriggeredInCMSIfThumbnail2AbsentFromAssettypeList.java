 ...
 * 4. Set for source assetType = thumbnail2 test,thumbnail3,original image and save
 * Make sure there is not exact thumbnail2 source
...
public class TC12574_SourceImageDoesNotTriggeredInCMSIfThumbnail2AbsentFromAssettypeList extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_PROGRAM);
        mpxLayer.updateImageAssetTypeByTitle(INITIAL_IMAGE, "Thumbnail", "Thumbnail3", "Original Image");
        mainRokuAdminPage.runCron(brand);
        ...
        softAssert.assertFalse(ImageUtil.compareUrlAndUrl(expectedSource, actualSource, 100.0),
                "Images source '3 tile program 3' are equals", "Images source '3 tile program 3' are not equals");
