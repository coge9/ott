 ...
 */
public class TC15028_SaveAndPublishVideo extends BaseAuthFlowTest {
    ...
    public void savePublishedVideoWorkflow(final String brand) {
        ...
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(title), "The node state is not Published", "The node state is Published", webDriver);
        ...
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(title), "The node state is not Published"
