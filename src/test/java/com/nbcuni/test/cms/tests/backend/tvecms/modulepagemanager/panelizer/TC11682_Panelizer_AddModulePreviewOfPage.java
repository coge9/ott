...
public class TC11682_Panelizer_AddModulePreviewOfPage extends BaseAuthFlowTest {
    ...
    @Test(groups = "preview_page", dataProviderClass = StaticBrandsProvider.class, dataProvider = "brandHasIOSDataProvider", enabled = true)
    public void checkThatAdminCouldSeeModuleOnPreview(String brand) {
        this.brand = brand;
