 ...
 */
public class TC12428_FeatureCarousel_PublishCuratedListForSeveralPlatforms extends BaseAuthFlowTest {
     ...
     * 3. Create a  feature Carousel with content list
     * 4. Assign feature Carousel to the Page 1 and Page 2
     *
    ...
    public void preconditionTC12428() {
        ...
        featureCarouselForm.setAssets(programs);
    ...
    public void listPostContainSeveralAppId(String brand) {
        ...
        pageInfoRoku = editPage.updateFields(Arrays.<Module>asList(featureCarouselForm));
        editPage.save();

        //Step 3
        editPage = rokuBackEndLayer.openEditOttPage(pageInfoAndroid.getTitle());
        pageInfoAndroid = editPage.updateFields(Arrays.<Module>asList(featureCarouselForm));
        editPage.save();
        ...
        RokuQueueJson expectedAssetJson = rokuBackEndLayer.getObject(null, featureCarouselForm.getAssets(), CuratedListType.CURATED, featureCarouselForm, pageInfoAndroid, pageInfoRoku);
