 ...
 */
public class TC9758_CheckAdminCanSetProgramAsContext extends BaseAuthFlowTest {
     ...
     * <p/>
     * Step 4: Click on "Context" autocomplete field, start to type any Program title
     * Verify: Autocomplete is offering all appropriate nodes
     * <p/>
     * Step 5: Select needed Program node from autocomplete list
     * Verify: Program node is selected
     * <p/>
