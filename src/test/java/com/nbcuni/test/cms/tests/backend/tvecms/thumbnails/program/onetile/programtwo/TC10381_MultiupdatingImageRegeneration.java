 ...
 */
public class TC10381_MultiupdatingImageRegeneration extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        mpxLayer.updateImageDimensionsByTitle(UPDATE_IMAGE, ProgramOneTileShowPageSource.getSourcePerBrand(brand).getWidth(),
                ProgramOneTileShowPageSource.getSourcePerBrand(brand).getHeight());
        mpxLayer.updateImageDimensionsByTitle(INITIAL_LOGO, "120", "20");
        mpxLayer.updateImageDimensionsByTitle(UPDATE_LOGO, "100", "20");
        ...
        String expected1tileProgram2 = GettingImages.getMultiupdating1TileProgram2();
