...
public class TC11687_Panelizer_DeleteModuleAsEditorAtPage extends BaseAuthFlowTest {
    ...
    public void checkThatAdminCouldDeleteModuleByPanelizer(String brand) {
        ...
        softAssert.assertTrue(mainRokuAdminPage.isStatusMessageShown(), "The status message is not shown after Page saving"
                , "The status message is shown after Page saving", webDriver);
        ...
        //Step2-7
        editPageWithPanelizer = rokuBackEndLayer.openEditOttPage(pageInfo.getTitle());
    ...
    private void deletePageTC11687() {
        try {
