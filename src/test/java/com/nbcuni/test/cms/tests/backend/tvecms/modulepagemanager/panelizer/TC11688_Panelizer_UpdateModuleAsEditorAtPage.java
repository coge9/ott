...
public class TC11688_Panelizer_UpdateModuleAsEditorAtPage extends BaseAuthFlowTest {
    ...
    public void checkThatAdminCouldUpdateModuleByPanelizer(String brand) {
        ...
        EditPageWithPanelizer editPageWithPanelizer = rokuBackEndLayer.addModule(pageInfo, shelfFirst);

        //Step2-10
        editPageWithPanelizer = rokuBackEndLayer.updateModule(shelfFirst, shelfSecond);
        ...
        Assertion.assertEqualsIgnoreCase(pageWithPanelizer.getShelfName(), shelfSecond.getTitle(),
                "The shelf name is not matched with set and those that present at View");
        Utilities.logInfoMessage("The shelf name on OTT Page view is matched with those that was set");
    }


    @AfterMethod(alwaysRun = true)
    public void deletePanelizerTC11688() {
        try {
            ...
            Utilities.logWarningMessage("The page and modules could not be deleted");
        }
