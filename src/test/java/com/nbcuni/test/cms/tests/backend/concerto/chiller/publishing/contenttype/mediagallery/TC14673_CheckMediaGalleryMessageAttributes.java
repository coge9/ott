 ...
 */
public class TC14673_CheckMediaGalleryMessageAttributes extends BaseAuthFlowTest {
     ...
     * <p/>
     * 2.Go To Content and select a Media Gallery
    ...
    public void testMediaGalleryPublishingAttributes(String brand) {
        ...
        softAssert.assertEquals(ItemTypes.MEDIA_GALLERY.getEntityType(), entityType, "The entityType message attribute are not matched",
    ...
    public void deleteGalleryTC14673() {
        try {
            ...
            Utilities.logSevereMessage("Couldn't delete the content");
        }
    }
