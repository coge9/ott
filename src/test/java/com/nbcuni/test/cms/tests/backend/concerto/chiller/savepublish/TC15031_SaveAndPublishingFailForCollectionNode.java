 ...
 */
public class TC15031_SaveAndPublishingFailForCollectionNode extends SetupAmazonEndpoint {
    /**
    ...
    public void savePublishFailCollections(final String brand) {
        //Step 1
        ...
        //Step 7
        collectionPage = collectionsContentPage.openEditCuratedCollectionPage(collection);
        collectionPage.publish(endpoint);
    ...
    public void deleteCollectionsTC15031() {
        try {
