...
/**
 * Created by Ivan_Karnilau on 25-Nov-15.
 */
 ...
 * Step 4: go to MPX
 *
 * Step 5: update test show's 983x554 Featured, iPhoneRetina, Large5 image with another one
 *
 * Step 6: go to Roku CMS
 * run Cron
 *
 * Step 7: uncheck "Override image"
 * save OTT Program
 *
 * Step 8: go to /admin/content
 * click "edit" next to test OTT Program
 *
 * Step 9: open 1tile thumbnail URL in browser
...
public class TC10727_OneTileThumbnailIs_CustomImage_RegeneratedAfterUpdateMPXImage extends BaseAuthFlowTest {
    ...
    public void checkCustomSource(final String brand) {
        ...
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_PROGRAM);
        mpxLayer.updateImageDimensionsByTitle(UPDATE_IMAGE, "983", "554");
        mpxLayer.updateImageDimensionsByTitle(INITIAL_IMAGE, "1", "1");
        ...
        String expectedUpdated1tileProgram1 = GettingImages.getOnlyImageUpdated1TileProgram1();
