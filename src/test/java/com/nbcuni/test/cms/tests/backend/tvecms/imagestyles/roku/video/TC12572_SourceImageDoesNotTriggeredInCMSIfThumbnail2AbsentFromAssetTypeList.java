 ...
 * 4. Set for source assetType = Thumbnail2 Test, android and save. Make sure no source with Thumbnail2 asset type and 2560x1440 size
 * the settings for Program is saved
 * There is no any surce with Thumbnail2 asest type
...
public class TC12572_SourceImageDoesNotTriggeredInCMSIfThumbnail2AbsentFromAssetTypeList extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        mpxLayer.updateImageAssetTypeByTitle(INITIAL_IMAGE, "Thumbnail3", "Thumbnail", "Android");
