...
/**
 * Created by Aleksandra_Lishaeva on 9/21/16.
 */
public class TC16101_FeatureCarouselRulePostIos extends BaseAuthFlowTest {
    ...
    private List<String> programsToAdd = null;
    ...
    private void featureCarouselRuleIOS(String brand) {
        ...
        featureCarousel = (FeatureCarouselForm) rokuBackEndLayer.getRulesStrategyForConcerto(ShelfType.FEATURE_CAROUSEL, programsToAdd, 1);
