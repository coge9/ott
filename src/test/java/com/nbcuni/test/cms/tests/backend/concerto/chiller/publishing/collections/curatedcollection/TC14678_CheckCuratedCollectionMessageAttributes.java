 ...
 */
public class TC14678_CheckCuratedCollectionMessageAttributes extends BaseAuthFlowTest {
    /**
     * Steps:
     * 1.Go To CMS as editor
     * Verify: The editor Panel is present
     * <p>
     * 2. Go To Collections Page and select a collection
     * Verify: The Edit Collection Page is opened
     * <p>
    ...
    public void testAttributes(String brand) {
        ...
        CuratedCollectionPage editPage = (CuratedCollectionPage) rokuBackEndLayer.createCollection(collection);
