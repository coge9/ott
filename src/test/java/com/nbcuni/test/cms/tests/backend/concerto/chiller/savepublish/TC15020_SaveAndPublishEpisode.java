 ...
 */
public class TC15020_SaveAndPublishEpisode extends BaseAuthFlowTest {
    ...
    public void savePublishEpisode(final String brand) {
        ...
        //Step 2
        ContentTypePage contentTypePage = (ContentTypePage) mainRokuAdminPage.openPage(content.getPage(), brand);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(content.getTitle())
                , "The node state is Published", "The node state is Not Published", webDriver);
        ...
        //Step 17
        contentPage = contentTypePage.cancel();
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(content.getTitle()), "The node state is Published after draft save"
        ...
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(content.getTitle()), "The node state is not Published after draft save"
