 ...
 */
public class TC14458_CheckUUIDforEvent extends BaseAuthFlowTest {
     ...
     * Pre-Conditions:Make sure drupal 'Devel' module is switch on
     ...
     2.Create a Event content types
     Verify: Event has created
     Edit Event Page is present
    ...
    public void initBusinessObject() {
        ...
        serviceEntity = new RegistryServiceEntity(ItemTypes.EVENT, content);
    }
