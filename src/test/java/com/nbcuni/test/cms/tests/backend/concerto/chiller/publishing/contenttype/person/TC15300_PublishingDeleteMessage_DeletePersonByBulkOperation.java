 ...
 * 2.
 * Delete Person by bulk operation
 * Person is deleted.
 ...
 * entityType = 'persons'
 */
public class TC15300_PublishingDeleteMessage_DeletePersonByBulkOperation extends BaseAuthFlowTest {
    ...
    public void testPersonDeletePublishing(String brand) {
        ...
        rokuBackEndLayer.deleteContentTypesByBulkOperation(person);
