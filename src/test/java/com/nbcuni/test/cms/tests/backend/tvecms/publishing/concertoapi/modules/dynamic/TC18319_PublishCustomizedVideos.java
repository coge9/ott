...
public class TC18319_PublishCustomizedVideos extends BaseAuthFlowTest {
    ...
    public void publishCustomizedVideo(String brand) {

        dynamic = CreationFactoryDynamicModule.createCustomizeDynamicForVideo(brand);
