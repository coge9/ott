...
public class TC10261_ApiPublishForEntityUpdateHeaderNewHeaderPost
        extends BaseAuthFlowTest {


    /**
     * TC10261 - Roku CMS: API Publish for entity Update(header): Added new header POST
     *
    ...
    private HeaderStyle headerStyle = HeaderStyle.WITHOUT_TITLE_WITH_MENU;
