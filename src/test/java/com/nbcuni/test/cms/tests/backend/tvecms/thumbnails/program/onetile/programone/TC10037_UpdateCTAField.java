 ...
 */
public class TC10037_UpdateCTAField extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        programContentPage.typeCTA(UPDATED_CTA);
        ...
        String patterFilePath = GettingImages.getCTAFieldUpdated1TileProgram1();
        softAssert.assertTrue(ImageUtil.compareScreenshotAndUrl(patterFilePath,
