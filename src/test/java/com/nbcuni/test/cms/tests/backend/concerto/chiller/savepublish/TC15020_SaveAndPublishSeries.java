 ...
 */
public class TC15020_SaveAndPublishSeries extends BaseAuthFlowTest {
    ...
    public void savePublishSeries(final String brand) {
        ...
        //Step 2
        ContentTypePage contentTypePage = (ContentTypePage) mainRokuAdminPage.openPage(series.getPage(), brand);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(series.getTitle()), "The node state is Published", "The node state is Not Published", webDriver);

        //Step 9
        contentTypePage = rokuBackEndLayer.editContentType(series);
        ...
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(series.getTitle()), "The node state is not Published"
        ...
        //Step 17
        contentPage = contentTypePage.cancel();
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(series.getTitle()), "The node state is Published after draft save"
        ...
        //Step 21
        contentPage = contentTypePage.cancel();
        softAssert.assertEquals(PublishState.PUBLISHED.getStateValue(), contentPage.getNodePublishState(series.getTitle())
