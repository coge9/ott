...
public class TC15162_ValidatePublishSchemeForImagesOnIOS extends BaseAuthFlowTest {
    ...
    @Test(groups = {"image_publishing"}, dataProviderClass = StaticBrandsProvider.class, dataProvider = "brandHasIOSDataProvider", enabled = false)
    public void CheckImageAfterPublishByCronIngest(String brand) {
        ...
        //Pre-Conditions
        Utilities.logInfoMessage("Check that ios thumbnail is generated for OTT Program");
        ...
        softAssert.assertTrue(programContentPage.onIosImagesTab().isAllIosImagesSourcePresent(),
                "Ios Image sources aren't present", webDriver);
