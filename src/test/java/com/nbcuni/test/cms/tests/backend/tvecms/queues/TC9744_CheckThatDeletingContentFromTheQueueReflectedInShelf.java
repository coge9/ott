...
public class TC9744_CheckThatDeletingContentFromTheQueueReflectedInShelf extends BaseAuthFlowTest {

    /**
     * TC9744 - P7: Roku CMS: Queues curation: Check that deleting content from the queue reflected in shelf
     *
     ...
     * Step 5: Delete one item in the queue
    ...
    public void deletedContentInQueueReflectedInShelf() {
        // step 1
