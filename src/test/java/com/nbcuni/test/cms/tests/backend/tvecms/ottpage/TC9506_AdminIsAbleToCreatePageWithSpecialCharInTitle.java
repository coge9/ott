...
public class TC9506_AdminIsAbleToCreatePageWithSpecialCharInTitle extends BaseAuthFlowTest {
    public String PAGE_TITLE = SimpleUtils.getSpecialCharacters(20);
     ...
     * <p/>
     * Step 4: Fill Special Chars symbols in title. Submit
    ...
    public void checkThatAdminCouldCreatePageWithSpecialCharsInTitle(String brand) {
        Utilities.logInfoMessage("Check that user is able to create an Page with special characters in Title ");
        SoftAssert softAssert = new SoftAssert();
        pageForm = CreateFactoryPage.createDefaultPageWithMachineNameAndAlias().setTitle(PAGE_TITLE).setPlatform(CmsPlatforms.IOS);
