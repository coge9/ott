 ...
 * 2. Create new Feature Show module and add items
...
public class TC17679_PublishFeatureShowModuleRokuWithUncheckedItem extends BaseAuthFlowTest {
    ...
    public void checkAllFieldsModulePublishingIOS(String brand) {
        ...
        //Get Expected result
        RokuQueueJson expectedQueueJson = new RokuQueueJson().getObject(brand, CuratedListType.CURATED, featureShowModule, pageForm);
