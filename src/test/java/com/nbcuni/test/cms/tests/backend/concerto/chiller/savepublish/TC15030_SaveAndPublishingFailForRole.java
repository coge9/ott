 ...
 */
public class TC15030_SaveAndPublishingFailForRole extends SetupAmazonEndpoint {
    /**
    ...
    public void savePublishFailPerson(final String brand) {
        //Step 1
        ...
        //Step 2-3
        ContentTypePage contentTypePage = rokuBackEndLayer.createContentType(person);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(person.getTitle()), "The node state is Published"
                , "The node state is not Published", webDriver);

        //Step 7
        rokuBackEndLayer.editContentType(person);
        contentTypePage.publish(endpoint);
