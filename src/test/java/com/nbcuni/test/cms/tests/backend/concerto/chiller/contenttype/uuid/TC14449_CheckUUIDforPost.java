 ...
 */
public class TC14449_CheckUUIDforPost extends BaseAuthFlowTest {
    /**
     * Pre-Conditions:Make sure drupal 'Devel' module is switch on
     ...
     2.Create a Post content types
     Verify: Post has created
     Edit Post Page is present
    ...
    public void checkUUID(String brand) {
        ...
        contentPage.searchByType(ContentType.TVE_POST).apply();
