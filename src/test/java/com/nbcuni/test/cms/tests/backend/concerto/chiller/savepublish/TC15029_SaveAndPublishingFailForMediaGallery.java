 ...
 */
public class TC15029_SaveAndPublishingFailForMediaGallery extends SetupAmazonEndpoint {
    /**
    ...
    public void savePublishFailMediaGallery(final String brand) {
        //Step 1
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(MediaGallery.getTitle()), "The node state is Published"
                , "The node state is not Published", webDriver);

        //Step 7
        rokuBackEndLayer.editContentType(MediaGallery);
        contentTypePage.publish(endpoint);
    ...
    public void deleteMediaGalleryTC15029() {
        try {
