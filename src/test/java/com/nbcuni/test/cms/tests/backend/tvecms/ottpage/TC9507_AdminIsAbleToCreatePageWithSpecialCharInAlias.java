...
public class TC9507_AdminIsAbleToCreatePageWithSpecialCharInAlias extends BaseAuthFlowTest {
    private MainRokuAdminPage mainRokuAdminPage;
    private TVEPage tvePage;
    private PageForm pageForm;
    private Slug alias = new Slug().setAutoSlug(false).setSlugValue("Alias" + SimpleUtils.getSpecialCharacters(20));
     ...
     * <p/>
     * Step 4: Fill Title and Special Chars symbols in Alias. Submit
    ...
    public void checkThatAdminCouldCreatePageWithSpecialCharsInAlias(String brand) {
        Utilities.logInfoMessage("Check that user is able to create an Page with special characters in Type ");
        SoftAssert softAssert = new SoftAssert();
        pageForm = CreateFactoryPage.createDefaultPageWithMachineNameAndAlias().setAlias(alias).setPlatform(CmsPlatforms.IOS);
