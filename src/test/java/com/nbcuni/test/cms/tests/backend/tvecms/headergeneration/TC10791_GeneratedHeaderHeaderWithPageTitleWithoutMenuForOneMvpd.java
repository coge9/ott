...
public class TC10791_GeneratedHeaderHeaderWithPageTitleWithoutMenuForOneMvpd extends
        BaseAuthFlowTest {
    ...
    /**
     * TC10791 - Roku CMS: Generated header "Header with Page Title without menu" for one MVPD
     *
    ...
    private String pageTitle = "HG V With T Without M";
