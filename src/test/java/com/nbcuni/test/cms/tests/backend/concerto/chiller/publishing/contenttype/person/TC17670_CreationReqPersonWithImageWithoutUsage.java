...
/**
 * TC17666
 * Pre-condition:Go to chiller CMS and create a Person with Required fields
 * <p>
 * Steps:
 * 1.Go to CMS as Editor
 * The Editor Navigation Panel is present
 * <p>
 * 2.Go to Content and select the Person from Pre-condition
 ...
 */
public class TC17670_CreationReqPersonWithImageWithoutUsage extends BaseAuthFlowTest {

    private Content content;

    @Autowired
    @Qualifier("requiredPersonWithImageWithoutUsage")
    ...
    @Test(groups = {"person_publishing"}, dataProviderClass = StaticBrandsProvider.class, dataProvider = "brandChillerDataProvider")
    public void creationPersonWithEmptyUsage(final String brand) {
        this.brand = brand;
        ...
        MetadataJson actualRoleJson = requestHelper.getSingleParsedResponse(url, ConcertoApiPublishingTypes.PERSON);
    ...
    public void deleteEventTC17670() {
        try {
