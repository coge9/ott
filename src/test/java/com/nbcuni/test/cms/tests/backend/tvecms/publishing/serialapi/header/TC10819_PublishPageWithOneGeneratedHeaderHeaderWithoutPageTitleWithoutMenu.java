...
public class TC10819_PublishPageWithOneGeneratedHeaderHeaderWithoutPageTitleWithoutMenu
        extends BaseAuthFlowTest {


    /**
     * TC10819 - Roku CMS: Publishing: Header: Publish page with one generated header (Header without Page Title without menu)
     *
    ...
    private HeaderStyle headerStyle = HeaderStyle.WITHOUT_TITLE_WITHOUT_MENU;
