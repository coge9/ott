...
public class TC14503_UploadingCoverMediaImageIsInLibrary extends BaseAuthFlowTest {
    ...
    public void creationMediaGallery(final String brand) {
        ...
        contentTypePage.onMediaTab().onMediaBlock().isImagesPresentInLibrary(Arrays.asList(expected), softAssert);
