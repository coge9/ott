 ...
 */
public class TC10038_UpdateHeadlineField extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram() {
        ...
        programContentPage.typeHeadline(UPDATED_HEADLINE);
        ...
        String patterFilePath = GettingImages.getHeadlineFieldUpdated1TileProgram1();
        softAssert.assertTrue(ImageUtil.compareScreenshotAndUrl(patterFilePath,
