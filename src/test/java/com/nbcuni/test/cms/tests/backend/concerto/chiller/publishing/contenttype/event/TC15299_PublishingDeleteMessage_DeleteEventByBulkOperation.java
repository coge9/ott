 ...
 * 2.
 * Delete Event by bulk operation
 * Event is deleted.
 ...
 * entityType = 'event'
 */
public class TC15299_PublishingDeleteMessage_DeleteEventByBulkOperation extends BaseAuthFlowTest {
    ...
    public void testEventDeletePublishing(String brand) {
        ...
        rokuBackEndLayer.deleteContentTypesByBulkOperation(event);
