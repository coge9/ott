 ...
 * 3. Select a source and set to assetType values = Original Image, android, and save
...
public class TC12566_SourceImageIsTriggeredInCMSIfOriginalImageExistInAssettypeList extends BaseAuthFlowTest {
    ...
    public void checkOneTileThumbnailIsGeneratedForOTTProgram(final String brand) {
        ...
        MPXLayer mpxLayer = new MPXLayer(brand, ContentType.TVE_VIDEO);
        mpxLayer.updateImageAssetTypeByTitle(INITIAL_IMAGE, "Original Image", "Android");
        mainRokuAdminPage.runCron(brand);
