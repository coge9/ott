 ...
 */
public class TC15320_PublishUpdatesOfCustomModuleIOS extends BaseAuthFlowTest {
    ...
    public void checkUpadtedFieldsModulePublishingConcerto(String brand) {
        ...
        updatedShelf = (Shelf) rokuBackEndLayer.getModulesStrategyForConcerto(ShelfType.SHELF);
        ...
        updatedShelf = draftModuleTab.createShelf(updatedShelf, PublishState.PUBLISHED);
        ...
        //Get Expected result
        CollectionJson expectedCollectionJson = new CollectionJson(updatedShelf);
    ...
    public void cleanUpContent() {
        try {
            rokuBackEndLayer.deleteModule(updatedShelf.getTitle());
