 ...
 */
public class TC15029_SaveAndPublishingFailForSeries extends SetupAmazonEndpoint {
    /**
    ...
    public void savePublishFailSeries(final String brand) {
        //Step 1
        ...
        //Step 2-3
        ContentTypePage contentTypePage = rokuBackEndLayer.createContentType(series);
        ...
        softAssert.assertEquals(PublishState.NOT_PUBSLISHED.getStateValue(), contentPage.getNodePublishState(series.getTitle()), "The node state is Published"
                , "The node state is not Published", webDriver);

        //Step 7
        rokuBackEndLayer.editContentType(series);
        contentTypePage.publish(endpoint);
    ...
    public void deleteSeriesTC15029() {
        try {
