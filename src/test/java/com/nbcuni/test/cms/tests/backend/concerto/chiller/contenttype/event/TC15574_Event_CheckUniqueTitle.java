 ...
 * 2. Create new Event with required fields [event_name]
 * Event is created
 * 3. Try create new Event with required fields [event_name]
 * Error message "Title is not unique" is present. New Event is not created
 * 4. Change title and save
 * Error message is not present
 * Content with new title is created
 */

public class TC15574_Event_CheckUniqueTitle extends BaseAuthFlowTest {
