...
@Component("requiredSeasonWithImageWithoutUsage")
public class WithRequiredSeasonAndImagesCreationStrategy implements ContentTypeCreationStrategy {
    @Override
    public Content createContentType() {
        ...
        season.getSeasonInfo()
                ...
                .setEndDate(new Date());
        season.setMediaImages(MediaFactory.createMediaWithImageCountWithoutUsages(2));
        return season;
    }
}
